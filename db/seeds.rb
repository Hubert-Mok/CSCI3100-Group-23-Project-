...
if Product.count.zero?
  ...
  products_data = [
    ...
    { title: "MATH1010 Lecture Notes Bundle", description: "Complete set of handwritten lecture notes for MATH1010 University Mathematics. Includes all tutorials and past paper solutions from 2024-2025.", price: 0.00, status: "available", listing_type: "gift", category: "Books & Notes", user: users[3] },
    ...
    { title: "Sony WH-1000XM4 Headphones", description: "Noise cancelling headphones in silver. Amazing sound quality. Comes with carrying case and aux cable. Battery lasts 30 hours.", price: 800.00, status: "available", listing_type: "sale", category: "Electronics", user: users[1] },

    # Clothing & Accessories
    { title: "Uniqlo Down Jacket - Size M", description: "Ultra light down jacket in navy blue. Worn only twice last winter. No stains or damage. Comes with original pouch for compact storage.", price: 380.00, status: "available", listing_type: "sale", category: "Clothing & Accessories", user: users[0] },
    ...
    # Furniture & Home
    { title: "IKEA ALEX Desk - White", description: "Study desk with two drawers. 131x60cm. Minor scratches on the surface. Must pick up from university dorm area. Disassembly needed.", price: 250.00, status: "available", listing_type: "sale", category: "Furniture & Home", user: users[1] },
    { title: "Desk Lamp - LED Adjustable", description: "USB rechargeable desk lamp with 3 brightness levels. Used for one semester. Giving away because I'm graduating.", price: 0.00, status: "available", listing_type: "gift", category: "Furniture & Home", user: users[6] },

    # Sports & Fitness
    { title: "Yoga Mat - 6mm Thick", description: "Purple yoga mat, used a few times. Non-slip surface, comes with carrying strap. Great for beginners or gym sessions.", price: 80.00, status: "available", listing_type: "sale", category: "Sports & Fitness", user: users[3] },
    { title: "Badminton Racket - Yonex Astrox", description: "Yonex Astrox 88D Pro racket. Restrung last month. Grip tape recently replaced. Perfect for intermediate to advanced players.", price: 450.00, status: "available", listing_type: "sale", category: "Sports & Fitness", user: users[7] },

    # Stationery & Supplies
    { title: "Muji Gel Pens - Pack of 10", description: "Brand new unopened pack of Muji 0.5mm gel pens in assorted colours. Bought extra by mistake.", price: 45.00, status: "available", listing_type: "sale", category: "Stationery & Supplies", user: users[2] },
    { title: "Scientific Calculator - Casio fx-991EX", description: "Required for many CUHK courses. Works perfectly, batteries recently replaced. Includes protective cover.", price: 90.00, status: "available", listing_type: "sale", category: "Stationery & Supplies", user: users[4] },

    # Food & Drinks
    { title: "Instant Noodle Collection", description: "Moving out sale! 15 packs of assorted instant noodles (Shin Ramyun, Indomie, Nissin). All within expiry date. Free pickup at Shaw College.", price: 0.00, status: "available", listing_type: "gift", category: "Food & Drinks", user: users[1] },
    ...
    { title: "Starbucks Gift Card - $100", description: "Starbucks gift card with $100 balance. Selling at a discount. Can verify balance in store together.", price: 85.00, status: "available", listing_type: "sale", category: "Tickets & Vouchers", user: users[7] },
    ...
    # Others
    { title: "Moving Out Bundle - Kitchen Items", description: "Graduating and moving out! Includes electric kettle, rice cooker, plates, cups, and utensils. Everything must go. Prefer to sell as a bundle.", price: 150.00, status: "available", listing_type: "sale", category: "Others", user: users[3] },
    { title: "Free Board Games Collection", description: "Settlers of Catan, Codenames, and Uno. All complete with no missing pieces. Great for hall gatherings. Pickup at United College.", price: 0.00, status: "available", listing_type: "gift", category: "Others", user: users[0] },
  ]
